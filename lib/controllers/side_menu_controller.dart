...
import 'package:dentist_dashboard/views/categories/categories_tab.dart';
...
class SideMenuController extends GetxController {
  final List<MenuModel> sideMenuItems = [
    ...
    MenuModel(title: "categories".tr, icon: Icons.category_rounded, isSelected: false, route: "categories", tab: 6),
  ];
